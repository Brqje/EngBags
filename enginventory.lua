...
function EngInventory_SetDefaultValues(re)
	...
	EI_SetDefault("show_Bag-2", 1, 1+re, EngBags_NumericRange, 0, 1);
        ...
        EI_SetDefault("frameWindowScale", 1.0, 1+re, EngBags_NumericRange, 0.64, 1.0);
	...
	EI_SetDefault("putinslot--EXPLOSIVE", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CUSTOM_01", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CUSTOM_02", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CUSTOM_03", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CUSTOM_04", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CUSTOM_05", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CUSTOM_06", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EI_SetDefault("putinslot--EMPTY_PROJECTILE_SLOTS", 14, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS); -- quiver and ammo bag empty slots
	EI_SetDefault("putinslot--USED_PROJECTILE_SLOTS", 14, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS); -- quiver and ammo bag used slots
	EI_SetDefault("putinslot--SOULSHARDS", 14, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
...
----------
	...
	EI_SetDefault("putinslot--BOE", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CLASSBOOK", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--DESIGN", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--FORMULA", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--MANUAL", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--PATTERN", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--PLANS", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EI_SetDefault("putinslot--REAGENT", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EI_SetDefault("putinslot--TRADESKILL_1", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TRADESKILL_2", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TRADESKILL_1_CREATED", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TRADESKILL_2_CREATED", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	
	EI_SetDefault("putinslot--OTHERSOULBOUND", 10, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);       -- this will usually be soulbound equipment	
	EI_SetDefault("putinslot--OTHERSOULBOUND_01_HEAD", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_02_NECK", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_03_SHOULDER", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_04_BACK", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_05_CHEST", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_06_SHIRT", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_07_TABARD", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_08_WRIST", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_09_HANDS", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_10_WAIST", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_11_LEGS", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_12_FEET", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_13_FINGER", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_14_TRINKET", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_15_MAINHAND", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_16_ONEHAND", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_17_OFFHAND", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_18_TWOHAND", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERSOULBOUND_19_RANGED", 10, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	
----------

	EI_SetDefault("putinslot--ROGUE_POISON", 9, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--WEAPON_BUFF", 9, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EI_SetDefault("putinslot--KEYS_1_OTHER", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS); -- items which act as keys
	EI_SetDefault("putinslot--KEYS_2_OTHER", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS); -- items which act as keys
	EI_SetDefault("putinslot--MISC", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--OTHERORUNKNOWN", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);      -- if not soulbound, but doesn't match any other category, it goes here
	EI_SetDefault("putinslot--QUESTITEMS", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_AHNQIRAJ", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS); -- Ahn'Qiraj scarabs are used for both Cenarion Circle & Brood of Nozdormu factions
	EI_SetDefault("putinslot--TOKEN_1_ARGENTDAWN", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_BLASTEDLANDS", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_CENARIONCIRCLE", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_FELWOOD", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_THORIUMBROTHERHOOD", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_UNGOROCRATER", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_WINTERSPRING", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_1_ZANDALARTRIBE", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_ALDOR", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_CENARIONEXPEDITION", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_HONORHOLD", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_INSTANCE", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_LOWERCITY", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_OGRILA", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_SCRYER", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_SPOREGGAR", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_THECONSORTIUM", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_2_THRALLMAR", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_BATTLEGROUND", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_LOVEISINTHEAIR_1", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_LOVEISINTHEAIR_2", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--TOKEN_LOVEISINTHEAIR_3", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	
	EI_SetDefault("putinslot--EQUIPPED", 7, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_01_HEAD", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_02_NECK", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_03_SHOULDER", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_04_BACK", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_05_CHEST", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_06_SHIRT", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_07_TABARD", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_08_WRIST", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_09_HANDS", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_10_WAIST", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_11_LEGS", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_12_FEET", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_13_FINGER", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_14_TRINKET", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_15_MAINHAND", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_16_ONEHAND", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_17_OFFHAND", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_18_TWOHAND", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--EQUIPPED_19_RANGED", 7, 1+re, EngInventory_NumericRange, 1, EngBags_MAX_BARS);

----------
	
	EI_SetDefault("putinslot--ELIXIR", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--ELIXIR_BATTLE", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--ELIXIR_BLASTEDLANDS", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--ELIXIR_GUARDIAN", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--ELIXIR_SOULBOUND", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--ELIXIR_ZANZA", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EI_SetDefault("putinslot--BANDAGE", 5, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--CONSUMABLE", 5, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--JUJU", 5, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EI_SetDefault("putinslot--POTION", 4, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--RUNE", 4, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

----------
	
	EI_SetDefault("putinslot--DRINK", 3, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--FOOD", 3, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EI_SetDefault("putinslot--CLASS_ITEMS1", 2, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--PROJECTILE", 2, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS); -- arrows and bullets that AREN'T in your quiver and/or ammo bag
	...
	EI_SetDefault("putinslot--KEYS_1", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--KEYS_2", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--MINIPET", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EI_SetDefault("putinslot--MOUNT", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EngInventoryConfig = newEngInventoryConfig;
		...
		EI_SetDefault("bar_sort_"..EngInventoryConfig["putinslot--POTION"], EngBags_SORTBYNAMEREV, 2+re, EngBags_NumericRange, EngBags_SORTLOWESTVALUE, EngBags_SORTHIGHESTVALUE);
		EI_SetDefault("bar_sort_"..EngInventoryConfig["putinslot--ELIXIR"], EngBags_SORTBYNAMEREV, 2+re, EngBags_NumericRange, EngBags_SORTLOWESTVALUE, EngBags_SORTHIGHESTVALUE);
