...
function EngBank_SetDefaultValues(re)
	...
	EBank_SetDefault("putinslot--EXPLOSIVE", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--CUSTOM_01", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--CUSTOM_02", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--CUSTOM_03", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--CUSTOM_04", 15, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
...
----------
	...
	EBank_SetDefault("putinslot--BOE", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--CLASSBOOK", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--DESIGN", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--FORMULA", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--MANUAL", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--PATTERN", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--PLANS", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EBank_SetDefault("putinslot--REAGENT", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	--EBank_SetDefault("putinslot--NON_CLASS_ITEMS1", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	--EBank_SetDefault("putinslot--NON_CLASS_ITEMS2", 12, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EBank_SetDefault("putinslot--TRADESKILL_1", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TRADESKILL_2", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TRADESKILL_1_CREATED", 11, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
...
----------
	...
	EBank_SetDefault("putinslot--ROGUE_POISON", 9, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--WEAPON_BUFF", 9, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EBank_SetDefault("putinslot--TOKEN_1_BATTLEGROUND", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EBank_SetDefault("putinslot--TOKEN_1_FELWOOD", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_1_THORIUMBROTHERHOOD", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_1_UNGOROCRATER", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_1_WINTERSPRING", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_1_ZANDALARTRIBE", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_ALDOR", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_CENARIONEXPEDITION", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_HONORHOLD", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_INSTANCE", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_LOWERCITY", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_OGRILA", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_SCRYER", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--TOKEN_2_SPOREGGAR", 8, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
...
----------
	...
	EBank_SetDefault("putinslot--ELIXIR", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--ELIXIR_BATTLE", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--ELIXIR_BLASTEDLANDS", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--ELIXIR_GUARDIAN", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--ELIXIR_SOULBOUND", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--ELIXIR_ZANZA", 6, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EBank_SetDefault("putinslot--BANDAGE", 5, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--CONSUMABLE", 5, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--JUJU", 5, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

	EBank_SetDefault("putinslot--POTION", 4, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--RUNE", 4, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);

----------
	
	EBank_SetDefault("putinslot--DRINK", 3, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EBank_SetDefault("putinslot--KEYS_1", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--KEYS_2", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--MINIPET", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	EBank_SetDefault("putinslot--MOUNT", 1, 1+re, EngBags_NumericRange, 1, EngBags_MAX_BARS);
	...
	EngBankConfig = newEngBankConfig;
	    ...
	    EBank_SetDefault("bar_sort_"..EngBankConfig["putinslot--POTION"], EngBags_SORTBYNAMEREV, 2+re, EngBags_NumericRange, EngBags_SORTLOWESTVALUE, EngBags_SORTHIGHESTVALUE);
	    EBank_SetDefault("bar_sort_"..EngBankConfig["putinslot--ELIXIR"], EngBags_SORTBYNAMEREV, 2+re, EngBags_NumericRange, EngBags_SORTLOWESTVALUE, EngBags_SORTHIGHESTVALUE);
