...
EngBank_LOCALIZATION = {
	...
	["string_searches"] = {
		{ -- english
			{ "MOUNT", "Use: Summons and dismisses a" }, -- mounts (includes engineering flying mount)
			{ "MOUNT", "Use: Summons and dismisses a rideable" }, -- regular & flying mounts
			...
			{ "ELIXIR", "Elixir" },
			{ "ELIXIR", "Battle and Guardian elixir" },
			{ "ELIXIR_BATTLE", "Elixir .* Battle Elixir" },
